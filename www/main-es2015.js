...
module.exports = __webpack_require__(/*! /Users/melanie/Desktop/LP/lescabanes/src/main.ts */"zUnb");
...
let FirebaseService = class FirebaseService {
     ...
     */
    getCoursEscaladeByJour(jour) {
        return this.firestore.collection('CoursEscalade', ref => ref.where('jour', '==', jour)
...
const routes = [
    {
        path: 'home',
        loadChildren: () => __webpack_require__.e(/*! import() | home-home-module */ "default~camp4-camp4-module~home-home-module").then(__webpack_require__.bind(null, /*! ./home/home.module */ "ct+p")).then(m => m.HomePageModule)
    },
    {
        path: '',
        redirectTo: 'home',
    ...
    {
        path: 'camp4',
        loadChildren: () => Promise.all(/*! import() | camp4-camp4-module */[__webpack_require__.e("default~camp4-camp4-module~home-home-module"), __webpack_require__.e("camp4-camp4-module")]).then(__webpack_require__.bind(null, /*! ./camp4/camp4.module */ "7GtZ")).then(m => m.Camp4PageModule)
    },
];
